...
const Main = () => {
  return (
    <div className="container w-full md:w-[75vw] flex flex-col flex-grow z-0 h-screen overflow-y-hidden bg-slate-200 bg-opacity-60 backdrop-blur-md backdrop-filter py-6 rounded-lg ms-0 md:mx-8">
