...
const Recent = () => {
  ...
  return (
    <div className="flex-grow overflow-y-auto font-raleway absolute bottom-0 sm:bottom-2 md:bottom-12 w-[75vw] md:w-[68vw] h-[200px]">
      <div className="p-4 border bg-gradient-to-b from-purple-200 to-purple-800 rounded-2xl shadow-lg shadow-slate-500">
